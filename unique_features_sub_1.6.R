...
plot_protein_features <- function(features_df, uniprot_id = NULL, sequence_length = NULL, terminus_highlight_length = 50) {
  ...
  # Define design impact levels and colors for category labels
  category_impact_colors <- list(
    "Targeting_Secretion" = "#dc3545",    # HIGH - Red
    "Membrane_Topology" = "#dc3545",     # HIGH - Red
    "Functional_Sites" = "#dc3545",      # HIGH - Red
    "Structural_Elements" = "#fd7e14",   # MEDIUM - Orange
    "Post_Translational_Modifications" = "#fd7e14", # MEDIUM-HIGH - Orange
    "Sequence_Variants" = "#28a745",     # LOW-MEDIUM - Green
    "Processing_Maturation" = "#fd7e14", # MEDIUM - Orange
    "Secondary_Structure" = "#28a745",   # LOW-MEDIUM - Green
    "Other_Features" = "#6c757d"         # VARIABLE - Gray
  )
  
  # Create track labels with color-coded HTML
  track_labels <- list()
