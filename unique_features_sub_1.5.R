...
plot_protein_features <- function(features_df, uniprot_id = NULL, sequence_length = NULL, terminus_highlight_length = 50) {
  ...
  feature_categories <- list(
    ...
    "Membrane_Topology" = list(
      ...
      track_start = 7,
      colors = c("#1ABC9C", "#E91E63", "#C8E6C9", "#FF5722", "#607D8B", "#795548")
    ),
    ...
    "Processing_Maturation" = list(
      ...
      track_start = 2,
      colors = c("#E8F0A3", "#26C6DA", "#EF5350", "#AB47BC", "#66BB6A", "#42A5F5", "#FFA726", "#26A69A")
    ),
    ...
    "Secondary_Structure" = list(
      ...
      colors = c("#FF0080", "#00FF80", "#8000FF", "#FF8000", "#0080FF", "#80FF00")
    ),
